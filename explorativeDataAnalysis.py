...
motion_df['day_name'] = motion_df['motion_timestamp'].dt.day_name()
...
temperature_df['day_name'] = temperature_df['temp_timestamp'].dt.day_name()
...
g = sns.FacetGrid(temperature_df, col="day_name", height=4, aspect=1.5)
g.map(sns.histplot, 'temp_value', kde=True, color='blue')
